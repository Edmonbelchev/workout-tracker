...
export function DebugPanel({ workout, fps }: DebugPanelProps) {
  return (
    <div className="pointer-events-none absolute inset-x-3 bottom-12 z-10 max-h-40 overflow-y-auto rounded-xl border border-zinc-700/80 bg-zinc-950/90 p-3 font-mono text-[11px] text-zinc-300 backdrop-blur-sm sm:inset-x-4">
